...
define('MIGUELBASE_PHPHTMLLIB', 'e:/unidadej/www/phphtmllib');
define('MIGUELBASE_ADODB', 'e:/unidadej/www/adodb_4.0.4');
define('MIGUELBASE_CACHEABLE', 0);
define('MIGUELBASE_LOG_ACTIVE', 1);
define('MIGUELBASE_LOG_TYPE', 'file');
define('MIGUELBASE_LOG_FILE', 'e:/unidadej/www/andromeda/var/temp/log/miguel.log');
define('MIGUELBASE_LOG_LEVEL', 'ERROR');
define('MIGUELBASE_SESSION_DIR', 'e:/unidadej/www/andromeda/var/temp/session');
define('MIGUELBASE_SESSION_TIME', 180);
define('MIGUELBASE_ERRORLOG_FILE', 'e:/unidadej/www/andromeda/var/temp/log/error.log');
