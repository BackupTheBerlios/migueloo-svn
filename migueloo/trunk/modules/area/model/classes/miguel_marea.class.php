...
class miguel_mArea extends base_Model
{
    ...
    {
    	$ret_val = $this->SelectCount('area_course', "institution_id = $institution_id AND faculty_id = $faculty_id AND department_id = $department_id  AND area_id = $area_id");
    ...
    function getCourse_old($institution_id=0, $faculty_id = 0, $department_id = 0, $area_id = 0)
    {
    	//Get code cours
