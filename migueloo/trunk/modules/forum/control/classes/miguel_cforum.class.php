            ...
            switch($status) {
                    ...
                    case 'list_topic':
                                ...
                                $arrUsers = $this->obj_data->getUsers();
                                    ...
                                    $this->addNavElement(Util::format_URLPath('forum/index.php', "status=list_topic&id_forum=$iId_forum"),'Tema');
                                    break;
                        case 'list_post':
                                    $iId_forum = $this->getViewVariable('id_forum');
                                ...
                                if ($this->issetViewVariable('submit')) {
                                    ...
                                    $this->addNavElement(Util::format_URLPath('forum/index.php', "status=list_post&id_forum=$iId_forum&id_topic=$iId_topic"),'Mensaje');
                    ...
                    default:
                            $arrForums = $this->obj_data->getForums();
                                    ...
                                    $this->clearNavBarr();
                                    $this->addNavElement(Util::format_URLPath('forum/index.php', 'status=list_forum'),'Foro');
                                    break;
                }
