...
/*
      ...
      +----------------------------------------------------------------------+
      | Authors: Eukene Elorza <eelorza@ikusnet.com>                         |
      |          Mikel Ruiz <mruiz@ikusnet.com>                              |
...
include_once (Util::app_Path("links/control/classes/miguel_clinks.class.php"));

$miguel = new miguel_CLinks();
$miguel->Exec();
