...
class miguel_newsubmenuForm extends base_FormContent
{
    function form_init_elements()
    {
                $name=$this->_formatElem("FEText", "name", "name", FALSE, "50");
                $name->set_attribute('class','ptabla03');
                ...
                $this->set_hidden_element_value('status', 'newSubmenu');
