...
class miguel_courseideasform extends base_FormContent
{
    function form_init_elements()
    {
		...
		if (isset($id)){
		    ...
		    $this->set_hidden_element_value('idi', $arrCourseIdeas[$id]['id']);
			$this->set_element_value('title', $arrCourseIdeas[$id]['title']);
			$this->set_element_value('body', $arrCourseIdeas[$id]['body']);
		} else {
    ...
    function form()
    {
        ...
        $table->add_row($this->_showElement('title', '7', 'title', 'Idea', 'title', 'left' ));
