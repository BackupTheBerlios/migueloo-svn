...
class miguel_RegistrarEntityManagerForm extends miguel_FormContent
{
	/**
	...
	function form_init_elements() 
	{
		...
		*/  
        ...
        //--------------------------------------------------	
		$elemRegistrar = $this->_formatElem("base_SubmitButton", "Registrar", "submit", agt('Registrar entidad'));
		$elemRegistrar->set_attribute('class','p'); 
		$this->add_element($elemRegistrar);
