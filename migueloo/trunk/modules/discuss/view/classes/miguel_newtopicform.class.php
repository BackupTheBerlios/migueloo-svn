...
class miguel_newTopicForm extends base_FormContent 
{
    ...
    function form() 
    {
        ...
        $table->add_row($this->_showElement('nombre', '8', 'nombre', agt('Nuevo Hilo: '), 'nombre', 'left' ));     
		$table->add_row($this->_showElement('descripcion', '9', 'descripcion', agt('Descripción'), 'descripcion', 'left' ));   
		$table->add_row($this->_showElement('normativa', '10', 'normativa', agt('Normativa'), 'normativa', 'left' ));     
