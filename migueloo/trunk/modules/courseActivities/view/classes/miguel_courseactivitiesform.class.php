...
class miguel_courseactivitiesform extends base_FormContent
{
    function form_init_elements()
    {
		...
		if (isset($id)){
		    ...
		    $this->set_hidden_element_value('idi', $arrCourseActivities[$id]['id']);
			$this->set_element_value('title', $arrCourseActivities[$id]['title']);
			$this->set_element_value('body', $arrCourseActivities[$id]['body']);
		} else {
    ...
    function form()
    {
        ...
        $table->add_row($this->_showElement('title', '7', 'title', 'Actividad', 'title', 'left' ));
