...
class miguel_VCourseActivities extends miguel_VMenu
{
    function miguel_VCourseActivities($title, $arr_commarea)
    {
    ...
    function right_block()
    {
		...
		switch($status)
		{
			case 'showForm':	$main->add($this->addForm('courseActivities', 'miguel_courseactivitiesform'));
									break;
			case 'update':
			case 'new':
			default:
