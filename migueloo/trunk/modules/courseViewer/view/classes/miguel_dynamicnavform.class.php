...
class miguel_dynamicNavForm extends miguel_FormContent
{
    function form_init_elements() 
    {
	   ...
	   */
	   ...
	   $this->add_element($this->_addButton('Cancelar', ''));
    ...
    function form() 
    {
        ...
        */
        $table->add_row($this->element_form("Cancelar"), $this->element_form("Aceptar"));

        return $table;
    }
    
    function _addButton($label, $class)
    {
    	$boton = $this->_formatElem("base_SubmitButton", "$label", "submit", "$label");
